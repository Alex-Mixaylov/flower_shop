# Generated by Django 5.1.2 on 2025-01-15 19:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color_code', models.CharField(help_text='Примеры HEX-кодов:<br><strong>Красный:</strong> #FF0000<br><strong>Белый:</strong> #FFFFFF<br><strong>Желтый:</strong> #FFFF00<br><strong>Черный:</strong> #000000<br><strong>Салатовый:</strong> #32CD32<br><strong>Оранжевый:</strong> #FFA500<br><strong>Фиолетовый:</strong> #800080<br><strong>Синий:</strong> #0000FF', max_length=7, verbose_name='Код цвета (HEX)')),
            ],
        ),
        migrations.CreateModel(
            name='FlowerType',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flower_colors', models.ManyToManyField(blank=True, related_name='products', to='orders.flowercolor', verbose_name='Цвета цветов')),
                ('flower_types', models.ManyToManyField(blank=True, related_name='products', to='orders.flowertype', verbose_name='Типы цветов')),
            ],
        ),
        migrations.CreateModel(
            name='ComboOffer',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('rating', models.PositiveIntegerField(help_text='Укажите рейтинг от 1 до 5', validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(5)], verbose_name='Рейтинг')),
